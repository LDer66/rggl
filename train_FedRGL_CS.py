...
parser.add_argument('--dataset', type=str, default="CS",choices=["Cora","CiteSeer","PubMed","Photo","CS","ogbn-arxiv","Physics"])
...
parser.add_argument('--warm-up', type=int, default=8)
parser.add_argument('--lp_prop', help='prop steps of label propagation', type=int, default=10)
...
parser.add_argument('--js_weight', type=float, default=0.3)
parser.add_argument('--alpha1', type=float, default=0.0)
parser.add_argument('--alpha2', type=float, default=0.5)
parser.add_argument('--beta', type=float, default=0.5)

##noise
parser.add_argument("--noisy_type", type=str, default="uniform",help="uniform, pair")
