...
parser.add_argument('--dataset', type=str, default="CiteSeer",choices=["Cora","CiteSeer","PubMed","Photo","CS","ogbn-arxiv","Physics"])
...
parser.add_argument('--only_stage2', type=bool, default=False, help='whether to use eonly_stage1 in noise labels')
